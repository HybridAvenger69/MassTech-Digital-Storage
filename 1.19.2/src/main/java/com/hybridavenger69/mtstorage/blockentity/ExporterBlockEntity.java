...
import com.hybridavenger69.mtstorage.apiimpl.network.node.ExporterNetworkNode;
...
public class ExporterBlockEntity extends NetworkNodeBlockEntity<ExporterNetworkNode> {
    ...
    public ExporterBlockEntity(BlockPos pos, BlockState state) {
        super(MSBlockEntities.EXPORTER.get(), pos, state, SPEC, ExporterNetworkNode.class);
    }
