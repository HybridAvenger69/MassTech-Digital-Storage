...
import com.hybridavenger69.mtstorage.apiimpl.network.node.NetworkTransmitterNetworkNode;
...
public class NetworkTransmitterBlockEntity extends NetworkNodeBlockEntity<NetworkTransmitterNetworkNode> {
    ...
    public NetworkTransmitterBlockEntity(BlockPos pos, BlockState state) {
        super(MSBlockEntities.NETWORK_TRANSMITTER.get(), pos, state, SPEC, NetworkTransmitterNetworkNode.class);
    }
