...
import com.hybridavenger69.mtstorage.apiimpl.network.node.CrafterNetworkNode;
...
import com.hybridavenger69.mtstorage.screen.CrafterBlockEntitySynchronizationClientListener;
...
public class CrafterBlockEntity extends NetworkNodeBlockEntity<CrafterNetworkNode> {
    ...
    public CrafterBlockEntity(BlockPos pos, BlockState state) {
        super(MSBlockEntities.CRAFTER.get(), pos, state, SPEC, CrafterNetworkNode.class);
    }
