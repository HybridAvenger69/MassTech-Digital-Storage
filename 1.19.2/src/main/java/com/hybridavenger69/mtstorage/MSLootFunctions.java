...
public final class MSLootFunctions {
   ...
   // public static final RegistryObject<LootItemFunctionType> PORTABLE_GRID;
    ...
    private static final DeferredRegister<LootItemFunctionType> LOOT_ITEM_FUNCTIONS = DeferredRegister.create(Registry.LOOT_FUNCTION_REGISTRY, HybridIDS.MTStorage_MODID);
