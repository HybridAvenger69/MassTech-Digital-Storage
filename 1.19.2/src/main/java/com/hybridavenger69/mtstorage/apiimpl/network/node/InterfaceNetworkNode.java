...
import com.hybridavenger69.mtstorage.apiimpl.storage.externalstorage.ItemExternalStorage;
import com.hybridavenger69.mtstorage.inventory.item.BaseItemHandler;
import com.hybridavenger69.mtstorage.inventory.item.ProxyItemHandler;
...
public class InterfaceNetworkNode extends NetworkNode implements IComparable {
    ...
    public int getEnergyUsage() {
        return MS.SERVER_CONFIG.getInterface().getUsage() + upgrades.getEnergyUsage();
    }
