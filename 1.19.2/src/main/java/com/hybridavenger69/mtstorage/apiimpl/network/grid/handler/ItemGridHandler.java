...
public class ItemGridHandler implements IItemGridHandler {
    ...
    public void onExtract(ServerPlayer player, UUID id, int preferredSlot, int flags) {
        ...
        if (!took.isEmpty()) {
            ...
            network.getNetworkItemManager().drainEnergy(player, MS.SERVER_CONFIG.getWirelessGrid().getExtractUsage());
        }
    }
    ...
    public ItemStack onInsert(ServerPlayer player, ItemStack stack, boolean single) {
        ...
        network.getNetworkItemManager().drainEnergy(player, MS.SERVER_CONFIG.getWirelessGrid().getInsertUsage());
    ...
    public void onCraftingCancelRequested(ServerPlayer player, @Nullable UUID id) {
        ...
        network.getNetworkItemManager().drainEnergy(player, id == null ? MS.SERVER_CONFIG.getWirelessCraftingMonitor().getCancelAllUsage() : MS.SERVER_CONFIG.getWirelessCraftingMonitor().getCancelUsage());
    }
