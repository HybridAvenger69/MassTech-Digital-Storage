...
import com.hybridavenger69.mtstorage.apiimpl.autocrafting.task.v6.CraftingPatternInputs;
import com.hybridavenger69.mtstorage.apiimpl.autocrafting.task.v6.CraftingTask;
...
import com.hybridavenger69.mtstorage.apiimpl.autocrafting.task.v6.node.NodeList;
import com.hybridavenger69.mtstorage.apiimpl.autocrafting.task.v6.node.ProcessingNode;
import com.hybridavenger69.mtstorage.apiimpl.autocrafting.task.v6.preview.CraftingPreviewElementFactory;
import com.hybridavenger69.mtstorage.apiimpl.autocrafting.task.v6.preview.CraftingPreviewInfo;
...
public class CraftingCalculator {
    ...
    private void calculateInternal(
        ...
        if (System.currentTimeMillis() - calculationStarted > MS.SERVER_CONFIG.getAutocrafting().getCalculationTimeoutMs()) {
