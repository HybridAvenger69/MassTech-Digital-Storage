...
import com.hybridavenger69.mtstorage.blockentity.grid.WirelessFluidGrid;
...
public class WirelessFluidGridGridFactory implements IGridFactory {
    public static final ResourceLocation ID = new ResourceLocation(HybridIDS.MTStorage_MODID, "wireless_fluid_grid");
