...
import com.hybridavenger69.mtstorage.api.autocrafting.craftingmonitor.ICraftingMonitorListener;
...
public class CraftingMonitorContainerMenu extends BaseContainerMenu implements ICraftingMonitorListener {
    ...
    public void onChanged() {
        MS.NETWORK_HANDLER.sendTo((ServerPlayer) getPlayer(), new CraftingMonitorUpdateMessage(craftingMonitor));
    }
}
