...
import com.hybridavenger69.mtstorage.container.slot.grid.CraftingGridSlot;
import com.hybridavenger69.mtstorage.container.slot.grid.ResultCraftingGridSlot;
import com.hybridavenger69.mtstorage.container.slot.legacy.LegacyBaseSlot;
import com.hybridavenger69.mtstorage.container.slot.legacy.LegacyDisabledSlot;
...
public class GridContainerMenu extends BaseContainerMenu implements ICraftingGridListener {
    ...
    public GridContainerMenu(IGrid grid, @Nullable BaseBlockEntity blockEntity, Player player, int windowId) {
        super(MSContainerMenus.GRID.get(), blockEntity, player, windowId);
