...
import com.hybridavenger69.mtstorage.screen.grid.AlternativesScreen;
import com.hybridavenger69.mtstorage.screen.widget.CheckboxWidget;
import com.hybridavenger69.mtstorage.screen.widget.sidebutton.SideButton;
...
public abstract class BaseScreen<T extends AbstractContainerMenu> extends AbstractContainerScreen<T> {
    ...
    private static final Component ALTERNATIVES_TEXT = Component.translatable("gui.mtstorage.alternatives");
    ...
    public void renderQuantity(PoseStack poseStack, int x, int y, String qty, int color) {
        boolean large = minecraft.isEnforceUnicode() || MS.CLIENT_CONFIG.getGrid().getLargeFont();
