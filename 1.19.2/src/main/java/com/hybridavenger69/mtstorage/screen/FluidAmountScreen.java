...
import com.hybridavenger69.mtstorage.container.FluidAmountContainerMenu;
...
public class FluidAmountScreen extends AmountSpecifyingScreen<FluidAmountContainerMenu> {
    ...
    public FluidAmountScreen(BaseScreen parent, Player player, int containerSlot, FluidStack stack, int maxAmount, @Nullable UnaryOperator<Screen> alternativesScreenFactory) {
        super(parent, new FluidAmountContainerMenu(player, stack), alternativesScreenFactory != null ? 194 : 172, 99, player.getInventory(), Component.translatable("gui.mtstorage.fluid_amount"));
    ...
    protected void onOkButtonPressed(boolean shiftDown) {
        try {
            ...
            MS.NETWORK_HANDLER.sendToServer(new SetFluidFilterSlotMessage(containerSlot, StackUtils.copy(stack, amount)));
