...
import com.hybridavenger69.mtstorage.apiimpl.render.CraftingPreviewElementDrawers;
import com.hybridavenger69.mtstorage.item.PatternItem;
import com.hybridavenger69.mtstorage.network.grid.GridCraftingStartRequestMessage;
...
public class CraftingPreviewScreen extends BaseScreen<AbstractContainerMenu> {
    ...
    public void onPostInit(int x, int y) {
        ...
        Button startButton = addButton(x + 129, y + 201 - 20 - 7, 50, 20, Component.translatable("misc.mtstorage.start"), true, true, btn -> startRequest());
    ...
    private void renderError(PoseStack poseStack, int x, int y, float scale, ErrorCraftingPreviewElement errorElement) {
        ...
        renderString(poseStack, RenderUtils.getOffsetOnScale(x + 5, scale), RenderUtils.getOffsetOnScale(y + 11, scale), I18n.get("gui.mtstorage.crafting_preview.error"));
    ...
    private void renderTooComplexError(PoseStack poseStack, int x, int y, float scale) {
        renderString(poseStack, RenderUtils.getOffsetOnScale(x + 5, scale), RenderUtils.getOffsetOnScale(y + 21, scale), I18n.get("gui.mtstorage.crafting_preview.error.too_complex.0"));
        renderString(poseStack, RenderUtils.getOffsetOnScale(x + 5, scale), RenderUtils.getOffsetOnScale(y + 31, scale), I18n.get("gui.mtstorage.crafting_preview.error.too_complex.1"));
    }

    private void renderRecursiveError(PoseStack poseStack, int x, int y, float scale, ItemStack recursedPattern) {
        renderString(poseStack, RenderUtils.getOffsetOnScale(x + 5, scale), RenderUtils.getOffsetOnScale(y + 21, scale), I18n.get("gui.mtstorage.crafting_preview.error.recursive.0"));
        renderString(poseStack, RenderUtils.getOffsetOnScale(x + 5, scale), RenderUtils.getOffsetOnScale(y + 31, scale), I18n.get("gui.mtstorage.crafting_preview.error.recursive.1"));
        renderString(poseStack, RenderUtils.getOffsetOnScale(x + 5, scale), RenderUtils.getOffsetOnScale(y + 41, scale), I18n.get("gui.mtstorage.crafting_preview.error.recursive.2"));
        renderString(poseStack, RenderUtils.getOffsetOnScale(x + 5, scale), RenderUtils.getOffsetOnScale(y + 51, scale), I18n.get("gui.mtstorage.crafting_preview.error.recursive.3"));

        renderString(poseStack, RenderUtils.getOffsetOnScale(x + 5, scale), RenderUtils.getOffsetOnScale(y + 61, scale), I18n.get("gui.mtstorage.crafting_preview.error.recursive.4"));
    ...
    private void startRequest() {
        MS.NETWORK_HANDLER.sendToServer(new GridCraftingStartRequestMessage(id, quantity, fluids));
