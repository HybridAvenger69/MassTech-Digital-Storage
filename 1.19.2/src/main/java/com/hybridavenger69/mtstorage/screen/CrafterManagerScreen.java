...
import com.hybridavenger69.mtstorage.screen.widget.sidebutton.CrafterManagerSearchBoxModeSideButton;
import com.hybridavenger69.mtstorage.screen.widget.sidebutton.GridSizeSideButton;
    ...
    public int getVisibleRows() {
        switch (crafterManager.getSize()) {
            case IGrid.SIZE_STRETCH:
                ...
                return Math.max(3, Math.min((screenSpaceAvailable / 18) - 3, MS.CLIENT_CONFIG.getCrafterManager().getMaxRowsStretch()));
