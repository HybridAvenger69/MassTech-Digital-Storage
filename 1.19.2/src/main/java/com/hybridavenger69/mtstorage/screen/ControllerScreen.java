...
import com.hybridavenger69.mtstorage.container.ControllerContainerMenu;
...
import com.hybridavenger69.mtstorage.blockentity.ClientNode;
...
public class ControllerScreen extends BaseScreen<ControllerContainerMenu> {
    ...
    public void renderForeground(PoseStack poseStack, int mouseX, int mouseY) {
        ...
        if (hoveringNode != null) {
            renderTooltip(poseStack, mouseX, mouseY, I18n.get("misc.mtstorage.energy_usage_minimal", hoveringNode.getEnergyUsage()));
        }

        if (RenderUtils.inBounds(ENERGY_BAR_X, ENERGY_BAR_Y, ENERGY_BAR_WIDTH, ENERGY_BAR_HEIGHT, mouseX, mouseY)) {
            renderTooltip(poseStack, mouseX, mouseY, I18n.get("misc.mtstorage.energy_usage", ControllerBlockEntity.ENERGY_USAGE.getValue()) + "\n" + I18n.get("misc.mtstorage.energy_stored", ControllerBlockEntity.ENERGY_STORED.getValue(), ControllerBlockEntity.ENERGY_CAPACITY.getValue()));
        }
    }
