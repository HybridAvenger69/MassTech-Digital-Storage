...
import com.hybridavenger69.mtstorage.block.StorageBlock;
import com.hybridavenger69.mtstorage.item.StoragePartItem;
    ...
    public InteractionResultHolder<ItemStack> use(Level level, Player player, InteractionHand hand) {
        ...
        if (!level.isClientSide && player.isCrouching() && type != ItemStorageType.CREATIVE) {
            ...
            if (disk == null || disk.getStored() == 0) {
                ...
                ItemStack stack = new ItemStack(MSBlocks.MACHINE_CASING.get());
