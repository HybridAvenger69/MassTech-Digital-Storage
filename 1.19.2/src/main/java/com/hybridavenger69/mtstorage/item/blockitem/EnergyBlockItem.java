...
import com.hybridavenger69.mtstorage.item.capabilityprovider.EnergyCapabilityProvider;
...
public abstract class EnergyBlockItem extends BaseBlockItem {
    ...
    public void appendHoverText(ItemStack stack, @Nullable Level level, List<Component> tooltip, TooltipFlag flag) {
        ...
        if (!creative) {
            stack.getCapability(ForgeCapabilities.ENERGY, null).ifPresent(energy -> tooltip.add(Component.translatable("misc.mtstorage.energy_stored", energy.getEnergyStored(), energy.getMaxEnergyStored()).setStyle(Styles.GRAY)));
        }
    }
}
