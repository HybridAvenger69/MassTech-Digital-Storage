...
public abstract class NetworkItem extends EnergyItem implements INetworkItemProvider {
    ...
    public void applyNetwork(MinecraftServer server, ItemStack stack, Consumer<INetwork> onNetwork, Consumer<Component> onError) {
        MutableComponent notFound = Component.translatable("misc.mtstorage.network_item.not_found");
    ...
    public void appendHoverText(ItemStack stack, @Nullable Level level, List<Component> tooltip, TooltipFlag flag) {
        ...
        if (isValid(stack)) {
            tooltip.add(Component.translatable("misc.mtstorage.network_item.tooltip", getX(stack), getY(stack), getZ(stack)).setStyle(Styles.GRAY));
        }
    }
