package com.hybridavenger69.mtstorage.config;
...
public class ServerConfig {
    ...
    public class StorageBlock {
        ...
        private final ForgeConfigSpec.IntValue oneTwentyEightKUsage;
        private final ForgeConfigSpec.IntValue twoFiftySixKUsage;
        private final ForgeConfigSpec.IntValue fiveTwelveKUsage;
        private final ForgeConfigSpec.IntValue oneZeroTwentyFourKUsage;
        private final ForgeConfigSpec.IntValue twoZeroFourtyEightK;
        ...
        public StorageBlock() {
            ...
            oneTwentyEightKUsage = builder.comment("The energy used by the 128k Storage Block").defineInRange("oneTwentyEighk", 9, 0, Integer.MAX_VALUE);
            twoFiftySixKUsage = builder.comment("The energy used by the 256k Storage Block").defineInRange("twoFiftySixk", 9, 0, Integer.MAX_VALUE);
            fiveTwelveKUsage = builder.comment("The energy used by the 512k Storage Block").defineInRange("fiveTwelvek", 9, 0, Integer.MAX_VALUE);
            oneZeroTwentyFourKUsage = builder.comment("The energy used by the 1024k Storage Block").defineInRange("oneZeroTwentyFourK", 10, 0, Integer.MAX_VALUE);
